-- Original repo: https://github.com/ncruces/sqlite-schema-diagram
...
SELECT
    CASE
        ...
        ELSE
            t.name || ' [label=<
            <TABLE BORDER="0" WIDTH="180px" CELLSPACING="0" CELLBORDER="1">
                <TR>
    ...
    END || '
                <TR>
                    ...
                    '</TD>
                    <TD WIDTH="130px" PORT="' || i.name || '_from">' || i.name || '</TD>
                </TR>
            ' ||
    CASE
